...
public static class ClipboardContentNormalizer
{
        ...
        ClipboardCaptureOptions options)
    {
        ...
        return new ClipboardCapturedItem
        {
            ...
            SourceApplicationUserModelId = snapshot.Source.ApplicationUserModelId,
            SourcePackageFamilyName = snapshot.Source.PackageFamilyName,
            SourceAccessStatus = (int)snapshot.Source.AccessStatus,
            SourceAttributionKind = (int)snapshot.Source.AttributionKind,
